# global folder paths
chengdu_dataset = '/Volumes/WD_BLACK/dataset/chengdu'
xian_dataset = '/Volumes/WD_BLACK/dataset/xian'
jiaotongsai_dataset = '/Volumes/WD_BLACK/dataset/jiaotongsai'

# geographical information processing parameters
grid_accuracy = 500
earth_radius = 6371004

# JIAOTONGSAI DATASET
process_folder = jiaotongsai_dataset
